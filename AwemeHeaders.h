...
@interface RTVInteractionAvatarView : UIView
...
@interface IESECGoodsFeedTagView : UIView
@end
...
// AWEDanmakuContainerView 已在下面定义
...
@end
@interface IESLLLivePurchaseAtmosphereView : UIView
@end
...
- (BOOL)prefersStatusBarHidden;
@end
@interface AWEFullPageFeedContainerViewController : UIViewController
- (BOOL)prefersStatusBarHidden;
@end
...
@interface AWEFeedPauseModalBaseComponent : NSObject
